...
function createEmailService({
  ...
  async function sendAccountVerification({
    ...
    const safeName = escapeHtml(displayName || 'Host');
    ...
    const response = await fetchImpl(apiUrl, {
      ...
      body: JSON.stringify({
        ...
        reply_to: replyTo,
        to: [to],
        subject: 'Verify your Markdown Mash host account',
        html: `<div style="font-family:Arial,sans-serif;max-width:560px;margin:auto;color:#15172b">
          ...
          <p>Hi ${safeName},</p>
          <p>Verify your email and create your host password to continue to the $15/year hosted plan.</p>
